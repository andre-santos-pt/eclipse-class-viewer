...
enum LayoutMode {
		Spring {
			@Override
			LayoutAlgorithm layoutAlgorithm(JModel model) {
...
//				TreeLayoutAlgorithm alg = new TreeLayoutAlgorithm(LayoutStyles.NO_LAYOUT_NODE_RESIZING);
				...
				alg.setComparator(new Comparator<LayoutEntity>() {
					...
					public int compare(LayoutEntity a1, LayoutEntity b1) {
						...
						JType a = (JType) ((GraphNode) a1.getGraphData()).getData();
						JType b = (JType)  ((GraphNode) b1.getGraphData()).getData();
...
//							return 0;
		...
		abstract LayoutAlgorithm layoutAlgorithm(JModel model);
...
//		private MenuItem item;
		...
		MenuItem createMenuItem(Menu parent, GraphViewer viewer, JModel model) {
